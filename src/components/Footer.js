...
const Footer = () => {
  return (
    <footer>
      <div className="container footer-content d-flex justify-content-center align-items-center">
        <div className="container">
          <span>&copy;caseyrey</span>
        </div>
        <div className="container d-flex justify-content-end ">
          <div className="p-1">
            <Link to="https://twitter.com/" target="_blank" className="icons">
              <svg
          ...
          <div className="p-1">
            <Link to="https://facebook.com/" target="_blank" className="icons">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"
          ...
          <div className="p-1">
            <Link to="https://instagram.com" target="_blank" className="icons">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
                height="16"

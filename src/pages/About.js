  ...
  return (
    <main className="d-flex justify-content-center align-items-center my-5">
      <div className="container border border-secondary page-transparent">
        <div className="container text-center text-satin-linen p-3">
          <h1>shopnflo - Your Ultimate Marketplace!</h1>
          <p>
            At shopnflo, we believe in empowering individuals to showcase and
            sell their unique products effortlessly. Our platform is designed
            with you in mind, offering a seamless and user-friendly experience
        ...
        <div className="accordion mb-5" id="accordionAbout">
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                <p>
                  shopnflo is on a mission to revolutionize the way people buy
                  and sell online. We are committed to providing a platform that
            ...
            >
              <div className="accordion-body">
                <p>
                  ...
                  supporting small businesses and individual creators. We've
                  come a long way since our inception, growing into a vibrant
                  community where sellers can turn their passions into thriving
                  online businesses.
                </p>
              </div>
            </div>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                <p>
                  Navigating our platform is a breeze. List your products,
                  manage your inventory, and connect with buyers effortlessly
                  through our intuitive interface.
                </p>
                <b>Your Store, Your Way:</b>
                <p>
                  Customize your storefront to reflect your brand. Showcase your
                  products with stunning visuals and personalized descriptions
                  ...
                  <li>
                    ...
                    <ul>
                      <li>
                        ...
                        elit. Quos ratione officiis dolore quisquam perspiciatis
                        deserunt debitis incidunt accusantium esse consequuntur,
                        iure ipsam sed, cumque commodi eveniet ducimus omnis
                        quasi aliquam!
                      </li>
                    </ul>
                  </li>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                <p>
                  At shopnflo, we're not just building a platform; we're
                  building a community. Join us in celebrating creativity,
                  supporting local businesses, and discovering unique products
                  that tell a story.
                </p>
              </div>
            </div>
            ...
            >
              <div className="accordion-body">
                <p>
                  <button
                    type="button"
                    className="btn btn-light-taupe text-satin-linen btn-md"
